...
void main() {
  // [テスト] AccountScreenAppRepository
  test("AccountScreenAppRepositoryのaddAccountがAccountDataを作成すること", () async {
    ...
    final account =
        await repository.addAccount(user, testAccountName, testAccountPurpose);
  ...
  testWidgets("AccountScreenViewModelのbodyが初期化されていること（タブレット）", (tester) async {
