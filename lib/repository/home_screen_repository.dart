...
abstract class HomeScreenRepository implements Repository {
  ...
  /// 指定したアカウントに登録されているカテゴリをリストで取得 <br />
  /// [account] リスト取得する対象のアカウント
  Future<List<CategoryData>> fetchCategoryList(AccountData account);

  /// 指定したアカウントに登録されている小カテゴリをリストで取得 <br />
  /// [account] リスト取得する対象のアカウント
  Future<List<MinorCategoryData>> fetchMinorCategoryList(AccountData account);
}
